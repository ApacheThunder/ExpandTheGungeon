...
// --------------------------------------------------------------------------
// - Adjusted by ApacheThunder to use defaults best for Enter the Gungeon.	-
// --------------------------------------------------------------------------
...
public class BlockDamageMapTool : EditorWindow
{
    ...
    private string[] blockSizeNames = new string[]{ "2", "4", "8", "16", "18", "32", "64", "128", "256", "512", "1024", "2048" };
    private int[] blockSizes = new int[]{ 2, 4, 8, 16, 18, 32, 64, 128, 256, 512, 1024, 2048 }; // Added 18 block size to be used for width on 16:9 aspect ratio when 1024 texture size is selected.
