...
namespace ExpandTheGungeon.Resources {
    ...
    public class RedShotGunMan : MonoBehaviour {
        ...
        public static void Init(AIActor sourceActor = null) {
            ...
            if (BootlegRedShotGunManTextures == null) {
            ...
            BootlegRedShotGunManCollection = ExpandUtility.BuildSpriteCollection(sourceActor.sprite.Collection, null, BootlegRedShotGunManTextures, ShaderCache.Acquire("tk2d/BlendVertexColorUnlitTilted"), false);
