    ...
    public class ExpandHooks {
            ...
            if (InstallHooks) {
                ...
                if (cellhook == null) {
                    ...
                    cellhook = new Hook(
                        ...
                        typeof(ExpandHooks).GetMethod("FlagCellsHook", BindingFlags.NonPublic | BindingFlags.Instance),
        ...
        public static void InstallMidGameSaveHooks() {
            ...
            onContinueGameSelectedHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("OnContinueGameSelected", BindingFlags.NonPublic | BindingFlags.Instance),
            ...
            generateRoomDoorMeshHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("GetNextTileset", BindingFlags.Public | BindingFlags.Instance),
                typeof(GameManager)
            );
        }
        ...
        public static void InstallRequiredHooks() {
            ...
            igniteGoopsCircleHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(IgniteGoopsCircleHook), BindingFlags.Public | BindingFlags.Static)
            );
            ...
            buildPatchHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(BuildPatchHook), BindingFlags.Public | BindingFlags.Instance),
            ...
            escapeRopeCanBeUsedHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(EscapeRopCanBeUsedHook), BindingFlags.Public | BindingFlags.Instance),
            ...
            clearPerLevelDataHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(ClearPerLevelData), BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(GameManager)
            );
            ...
            clearActiveGameDataHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(ClearActiveGameData), BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(GameManager)
            );
            ...
            objectstamphook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("ApplyObjectStampHook", BindingFlags.Public | BindingFlags.Static)
            );
            ...
            placeRoomHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("PlaceRoomHook", BindingFlags.Public | BindingFlags.Static)
            );
            ...
            getRandomFlowHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("GetRandomFlowHook", BindingFlags.Public | BindingFlags.Instance),
            ...
            handlePitfallHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("HandlePitfallHook", BindingFlags.Public | BindingFlags.Instance),
                typeof(GetKicked)
            );
            ...
            arrivalElevatorUpdateHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("ArrivalElevatorUpdateHook", BindingFlags.Public | BindingFlags.Instance),
            ...
            constructTK2DDungeonHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("ConstructTK2DDungeonHook", BindingFlags.Public | BindingFlags.Instance),
            ...
            handleGrabbyGrabHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("HandleGrabbyGrabHook", BindingFlags.NonPublic | BindingFlags.Instance),
            ...
            sellPitConfigureOnPlacementHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("SellPitConfigureOnPlacementHook", BindingFlags.Public | BindingFlags.Instance),
            ...
            playerFiredHook = new Hook(
               ...
               typeof(ExpandHooks).GetMethod("PlayerFiredHook", BindingFlags.NonPublic | BindingFlags.Instance),
            ...
            generateRoomDoorMeshHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("GenerateRoomDoorMeshHook", BindingFlags.NonPublic | BindingFlags.Static)
            );
            ...
            animationCompletedHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("AnimationCompletedHook", BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(AIAnimator)
            );
            ...
            teardownPunchoutHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(TeardownPunchout_Hook), BindingFlags.NonPublic | BindingFlags.Instance),
            ...
            buildorderLayerCenterJungleHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("BuildBorderLayerCenterJungleHook", BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(TK2DDungeonAssembler)
            );
            ...
            getTypeBorderGridForBorderIndexHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("GetTypeBorderGridForBorderIndexHook", BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(TK2DDungeonAssembler)
            );
            ...
            postGenerationCleanupHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("PostGenerationCleanupHook", BindingFlags.Public | BindingFlags.Instance),
                typeof(DungeonData)
            );
            ...
            /*Hook handleBulletDeletionFramesHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("HandleBulletDeletionFrames", BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(Exploder)
            );*/
            ...
            throwGunHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod("ThrowGunHook", BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(Gun)
            );
            ...
            placePlayerInRoomHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(PlacePlayerInRoomHook), BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(Dungeon)
            );
            ...
            floodFillDungeonInteriorHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(FloodFillDungeonInteriorHook), BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(DungeonData)
            );
            ...
            initNearbyTileCheckHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(InitNearbyTileCheck), BindingFlags.NonPublic | BindingFlags.Instance),
            ...
            getTileHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(GetTile), BindingFlags.NonPublic | BindingFlags.Instance),
                typeof(PhysicsEngine)
            );
            ...
            floorChestPlacerConfigureOnPlacementHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(FloorChestPlacerConfigureOnPlacementHook)),
            ...
            applyBenefitHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(ApplyBenefit)),
            ...
            flagCellsHook = new Hook(
                ...
                typeof(ExpandHooks).GetMethod(nameof(FlameTrapOnDestroyHook), BindingFlags.NonPublic | BindingFlags.Instance),
        ...
        /*public Texture2D GenerateOcclusionTextureHook(Func<OcclusionLayer, int, int, DungeonData, Texture2D>orig, OcclusionLayer self, int baseX, int baseY, DungeonData d) {
            ...
            FieldInfo m_allPlayersCachedField = typeof(OcclusionLayer).GetField("m_allPlayersCached", BindingFlags.Instance | BindingFlags.NonPublic);
            
            GameManager m_gameManagerCached = GameManager.Instance;
            Pixelator m_pixelatorCached = Pixelator.Instance;
            PlayerController[] m_allPlayersCached = GameManager.Instance.AllPlayers;

            m_gameManagerCachedField.SetValue(self, m_gameManagerCached);
            m_pixelatorCachedField.SetValue(self, m_pixelatorCached);
            m_allPlayersCachedField.SetValue(self, m_allPlayersCached);


            typeof(OcclusionLayer).GetField("m_playerOneDead", BindingFlags.Instance | BindingFlags.NonPublic).SetValue(self, (!m_gameManagerCached.PrimaryPlayer || m_gameManagerCached.PrimaryPlayer.healthHaver.IsDead));
            if (m_gameManagerCached.CurrentGameType == GameManager.GameType.COOP_2_PLAYER) {
                typeof(OcclusionLayer).GetField("m_playerTwoDead", BindingFlags.Instance | BindingFlags.NonPublic).SetValue(self, (!m_gameManagerCached.SecondaryPlayer || m_gameManagerCached.SecondaryPlayer.healthHaver.IsDead));
            }

            int num = m_pixelatorCached.CurrentMacroResolutionX / 16 + 4;
            int num2 = m_pixelatorCached.CurrentMacroResolutionY / 16 + 4;
            int num3 = num * ReflectGetField<int>(typeof(OcclusionLayer), "textureMultiplier", self);
            int num4 = num2 * ReflectGetField<int>(typeof(OcclusionLayer), "textureMultiplier", self);

            Texture2D m_occlusionTexture = ReflectGetField<Texture2D>(typeof(OcclusionLayer), "m_occlusionTexture", self);
            ...
            if (m_occlusionTexture == null || m_occlusionTexture.width != num3 || m_occlusionTexture.height != num4) {
                if (m_occlusionTexture != null) {
                    ...
                    typeof(OcclusionLayer).GetField("m_occlusionTexture", BindingFlags.Instance | BindingFlags.NonPublic).SetValue(self, m_occlusionTexture);
                }
            }

            Color[] m_colorCache = ReflectGetField<Color[]>(typeof(OcclusionLayer), "m_colorCache", self);

            if (m_colorCache == null || m_colorCache.Length != num3 * num4) { m_colorCache = new Color[num3 * num4]; }
            typeof(OcclusionLayer).GetField("m_colorCache", BindingFlags.Instance | BindingFlags.NonPublic).SetValue(self, m_colorCache);
            ...
            if (!m_gameManagerCached.IsLoadingLevel) {
                for (int i = 0; i < num3; i++) {
                    for (int j = 0; j < num4; j++) {
                        int num5 = j * num3 + i;
                        float worldX = i / ReflectGetField<int>(typeof(OcclusionLayer), "textureMultiplier", self);
                        float worldY = j / ReflectGetField<int>(typeof(OcclusionLayer), "textureMultiplier", self);
                        m_colorCache[num5] = GetInterpolatedValueAtPoint(self, m_pixelatorCached, baseX, baseY, worldX, worldY, d);
                        typeof(OcclusionLayer).GetField("m_colorCache", BindingFlags.Instance | BindingFlags.NonPublic).SetValue(self, m_colorCache);
                    }
                }
            }
            ...
            typeof(OcclusionLayer).GetField("m_occlusionTexture", BindingFlags.Instance | BindingFlags.NonPublic).SetValue(self, m_occlusionTexture);
            Tools.ExportTexture(m_occlusionTexture);
            return m_occlusionTexture;
        }
        
        protected float GetRValueForCell(OcclusionLayer self, Pixelator m_pixelatorCached, int x0, int y0, DungeonData d) {
            float result = 0f;
            if (m_pixelatorCached.UseTexturedOcclusion) { return result; }
            if (x0 < 0 || x0 >= d.Width || y0 < 0 || y0 >= d.Height) { return result; }
            CellData cellData = d[x0, y0];
            if (cellData == null) { return result; }
            if (cellData.isExitCell) { return result; }
            if (cellData.type == CellType.WALL && !cellData.IsAnyFaceWall()) { return result; }
            if (y0 - 2 >= 0 && d[x0, y0 - 2] != null && d[x0, y0 - 2].isExitCell) { return result; }
            RoomHandler roomHandler = d[x0, y0].parentRoom ?? d[x0, y0].nearestRoom;
            bool flag = false;
            if (roomHandler != null) {
                PlayerController[] m_allPlayersCached = ReflectGetField<PlayerController[]>(typeof(OcclusionLayer), "m_allPlayersCached", self);
                bool m_playerOneDead = ReflectGetField<bool> (typeof(OcclusionLayer), "m_playerOneDead", self);
                bool m_playerTwoDead = ReflectGetField<bool>(typeof(OcclusionLayer), "m_playerTwoDead", self);
                for (int i = 0; i < m_allPlayersCached.Length; i++) {
                    if (i != 0 || !m_playerOneDead) {
                        if (i != 1 || !m_playerTwoDead) {
                            if (m_allPlayersCached[i].CurrentRoom != null && m_allPlayersCached[i].CurrentRoom.connectedRooms != null && m_allPlayersCached[i].CurrentRoom.connectedRooms.Contains(roomHandler)) {
                                flag = true;
                            }
                        }
                    }
            ...
            if (x0 < 1 || x0 > d.Width - 2 || y0 < 3 || y0 > d.Height - 2) { return result; }
            if (roomHandler == null || roomHandler.visibility == RoomHandler.VisibilityStatus.OBSCURED || roomHandler.visibility == RoomHandler.VisibilityStatus.REOBSCURED) {
                if (flag) {
                    if (cellData.isExitNonOccluder) { return result; }
                    if (cellData.isExitCell) { return result; }
                    if (y0 > 1 && d[x0, y0 - 1] != null && d[x0, y0 - 1].isExitCell) { return result; }
                    if (y0 > 2 && d[x0, y0 - 2] != null && d[x0, y0 - 2].isExitCell) { return result; }
                    if (y0 > 3 && d[x0, y0 - 3] != null && d[x0, y0 - 3].isExitCell) { return result; }
                    if (x0 > 1 && d[x0 - 1, y0] != null && d[x0 - 1, y0].isExitCell) { return result; }
                    if (x0 < d.Width - 1 && d[x0 + 1, y0] != null && d[x0 + 1, y0].isExitCell) { return result; }
                }
                result = 1f;
            }
            return result;
        ...
        protected float GetGValueForCell(Pixelator m_pixelatorCached, int x0, int y0, DungeonData d) {
            float result = 0f;
            if (x0 < 0 || x0 >= d.Width || y0 < 0 || y0 >= d.Height) { return result; }
            CellData cellData = d[x0, y0];
            if (cellData == null) { return result; }
        ...
        protected Color GetInterpolatedValueAtPoint(OcclusionLayer self, Pixelator m_pixelatorCached, int baseX, int baseY, float worldX, float worldY, DungeonData d) {
            int num = baseX + Mathf.FloorToInt(worldX);
            int num2 = baseY + Mathf.FloorToInt(worldY);
            num = baseX + (int)worldX;
            num2 = baseY + (int)worldY;
            float rvalueForCell = GetRValueForCell(self, m_pixelatorCached, num, num2, d);
            float gvalueForCell = GetGValueForCell(m_pixelatorCached, num, num2, d);
            if (!d.CheckInBounds(num, num2)) { return new Color(rvalueForCell, gvalueForCell, 0f, 0f); }
            float num3 = Mathf.Clamp01(GetCellOcclusion(m_pixelatorCached, num, num2, d));
            float a = 1f - num3 * num3;
            return new Color(rvalueForCell, gvalueForCell, 0f, a);
        }

        protected float GetCellOcclusion(Pixelator m_pixelatorCached, int x0, int y0, DungeonData d) {
            ...
            if (!m_pixelatorCached.UseTexturedOcclusion && x0 >= 2 && y0 >= 2 && x0 < d.Width - 2 && y0 < d.Height - 2) {
                float num2 = 0f;
                float num3 = 0f;
                float[] KERNEL = new float[] { 0.12f, 0.25f, 0.3f, 0.25f, 0.12f };
                for (int i = -2; i <= 2; i++) {
                    for (int j = -2; j <= 2; j++) {
