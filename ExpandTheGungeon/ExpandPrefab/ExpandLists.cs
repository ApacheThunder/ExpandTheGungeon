...
namespace ExpandTheGungeon.ExpandPrefab {
    ...
    public static class ExpandLists {
        ...
        public static readonly List<string> EXItem_Collection = new List<string> {
            "babygoodhammer",
        ...
        public static readonly List<string> EXBalloon_Collection = new List<string> {
        ...
        public static readonly List<string> EXPortableElevator_Collection = new List<string> {
