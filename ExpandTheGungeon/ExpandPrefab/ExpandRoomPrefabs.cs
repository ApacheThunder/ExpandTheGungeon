...
namespace ExpandTheGungeon.ExpandPrefab {
    ...
    public class ExpandRoomPrefabs {
        ...
        public static void InitCustomRooms(AssetBundle expandSharedAssets1, AssetBundle sharedAssets, AssetBundle sharedAssets2, AssetBundle braveResources, AssetBundle EnemiesBundle) {
            ...
            // This room rebuilt with less traps (Now using RoomFactory API instead of RoomBuilder)
            Expand_Apache_TheCrushZone = RoomFactory.BuildFromAssetBundle(AssetBundles, "Expand_TheCrushZone", true, assignDecorationSettings: true);
            ...
            // Added more safe areas and ported to RoomFactory API
            Expand_Apache_PitTraps = RoomFactory.BuildFromAssetBundle(AssetBundles, "Expand_PitTraps", true, assignDecorationSettings: true);
