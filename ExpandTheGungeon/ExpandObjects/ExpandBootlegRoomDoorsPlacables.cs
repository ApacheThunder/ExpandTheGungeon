...
namespace ExpandTheGungeon.ExpandObjects {
    ...
    public class ExpandBootlegRoomPlaceable : DungeonPlaceableBehaviour, IPlaceConfigurable {
        ...
        public static void BuildPrefab() {
            ...
            GameObject m_BorderObject_West = new GameObject("BootlegRoomBorder_West") { layer = 20 };
            GameObject m_BorderObject_East = new GameObject("BootlegRoomBorder_East") { layer = 20 };
            GameObject m_BorderObject_North = new GameObject("BootlegRoomBorder_North") { layer = 20 };
            GameObject m_BorderObject_South = new GameObject("BootlegRoomBorder_South") { layer = 20 };
            ...
            GameObject m_DoorBlockObject_West = new GameObject("BootlegRoomDoorBlocker(West)") { layer = 20 };
            GameObject m_DoorBlockObject_East = new GameObject("BootlegRoomDoorBlocker(East)") { layer = 20 };
            GameObject m_DoorBlockObject_South = new GameObject("BootlegRoomDoorBlocker(South)") { layer = 20 };
            GameObject m_DoorBlockObject_North = new GameObject("BootlegRoomDoorBlocker(North)") { layer = 20 };
            m_BorderObject_West.transform.position -= new Vector3(3, 3);
            m_BorderObject_East.transform.position -= new Vector3(3, 3);
            m_BorderObject_North.transform.position -= new Vector3(3, 3);
            m_BorderObject_South.transform.position -= new Vector3(3, 3);
            m_BorderObject_West.transform.parent = ExpandPrefabs.EXBootlegRoomObject.transform;
            m_BorderObject_East.transform.parent = ExpandPrefabs.EXBootlegRoomObject.transform;
            m_BorderObject_North.transform.parent = ExpandPrefabs.EXBootlegRoomObject.transform;
            m_BorderObject_South.transform.parent = ExpandPrefabs.EXBootlegRoomObject.transform;
            m_DoorFrameObject.transform.parent = ExpandPrefabs.EXBootlegRoomObject.transform;

            m_DoorObject.transform.parent = ExpandPrefabs.EXBootlegRoomDoorTriggers.transform;
            m_DoorBlockObject_West.transform.parent = ExpandPrefabs.EXBootlegRoomDoorTriggers.transform;
            m_DoorBlockObject_East.transform.parent = ExpandPrefabs.EXBootlegRoomDoorTriggers.transform;
            m_DoorBlockObject_South.transform.parent = ExpandPrefabs.EXBootlegRoomDoorTriggers.transform;
            m_DoorBlockObject_North.transform.parent = ExpandPrefabs.EXBootlegRoomDoorTriggers.transform;
        ...
        public void ConfigureOnPlacement(RoomHandler room) {
            ...
            DoorFrames.transform.parent = room.hierarchyParent;
