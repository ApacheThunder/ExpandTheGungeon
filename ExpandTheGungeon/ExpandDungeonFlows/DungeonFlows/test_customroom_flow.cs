...
namespace ExpandTheGungeon.ExpandDungeonFlows {
    ...
    public class test_customroom_flow : ExpandDungeonFlow {
        ...
        public static DungeonFlow Test_CustomRoom_Flow() {
            ...
            DungeonFlowNode TestRoomNode_01 = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.NORMAL, ExpandRoomPrefabs.Expand_Apache_PitTraps);
            ...
            // DungeonFlowNode TestTinyRewardNode = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.CONNECTOR, ExpandPrefabs.reward_room);
